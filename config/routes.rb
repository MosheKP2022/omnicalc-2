Rails.application.routes.draw do
  ...
  get("/subtract", ({ :controller=> "application", :action=>"subtract_results"}))
  get("/multiply", ({ :controller=> "application", :action=>"multiply_results"}))
  get("/divide", ({ :controller=> "application", :action=>"divide_results"}))
